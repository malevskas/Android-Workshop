...
public class Maps extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapLoadedCallback, GoogleMap.OnMarkerClickListener {
    ...
    public void readCities() {
        if(grad.equals("Скопје")) {
            Scanner scan = new Scanner(getResources().openRawResource(R.raw.skopje));
            while (scan.hasNextLine()) {
                String name = scan.nextLine();
                if(name.isEmpty()) break;
                if(name.equals(lokacija)) {
        ...
        if(grad.equals("Куманово")) {
            Scanner scan = new Scanner(getResources().openRawResource(R.raw.kumanovo));
            while (scan.hasNextLine()) {
                String name = scan.nextLine();
                if(name.isEmpty()) break;
                if(name.equals(lokacija)) {
        ...
        if(grad.equals("Тетово")) {
            Scanner scan = new Scanner(getResources().openRawResource(R.raw.tetovo));
            while (scan.hasNextLine()) {
                String name = scan.nextLine();
                if(name.isEmpty()) break;
                if(name.equals(lokacija)) {
        ...
        if(grad.equals("Охрид")) {
            Scanner scan = new Scanner(getResources().openRawResource(R.raw.ohrid));
            while (scan.hasNextLine()) {
                String name = scan.nextLine();
                if(name.isEmpty()) break;
                if(name.equals(lokacija)) {
        ...
        if(grad.equals("Битола")) {
            Scanner scan = new Scanner(getResources().openRawResource(R.raw.bitola));
            while (scan.hasNextLine()) {
                String name = scan.nextLine();
                if(name.isEmpty()) break;
                if(name.equals(lokacija)) {
